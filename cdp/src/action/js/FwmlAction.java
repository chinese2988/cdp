...
public class FwmlAction extends BaseAction{
...
public String execute() {
	...
	if (session.get("user_session") != null) {
		try {
			...
			fwmls=ud.findAllFwml(pageSize, pageNow);
	...
	public void setFwml(fwml fwml) {
		this.fwml = fwml;
	}


	public ArrayList<fwml> getFwmls() {
		return fwmls;
	}


	public void setFwmls(ArrayList<fwml> fwmls) {
		this.fwmls = fwmls;
	}
