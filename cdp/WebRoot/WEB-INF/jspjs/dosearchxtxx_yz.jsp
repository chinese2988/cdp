		...
		<div id="sideNav" href=""><i class="material-icons dp48">toc</i></div>
            ...
            <ul class="nav navbar-top-links navbar-right"> 
				...
				<li><a class="dropdown-button waves-effect waves-dark" href="#!" data-activates="dropdown2"><i class="fa fa-bell fa-fw"></i> <i class="material-icons right">arrow_drop_down</i></a></li>
				  <li><a class="dropdown-button waves-effect waves-dark" href="#!" data-activates="dropdown1"><i class="fa fa-user fa-fw"></i> <b><s:property
							value="#session.user_session.loginname" /></b> <i class="material-icons right">arrow_drop_down</i></a></li>
            </ul>
        </nav>
		<!-- Dropdown Structure -->
            ...
            <div id="page-inner">
                ...
                <div class="row">
					...
					<td width="10%" class="center">
					 统计<input type="text"  name="stjsj" style="display:none" value="<s:property value="htkssjs" />" /> 
					</td>
					...
					<select style="display:block" name="htkssjs">
							...
							<option value="<s:property value='#xtxxyz2.tjsj'  />" <s:if test="#xtxxyz2.tjsj==htkssjs" >selected="selected"</s:if> >   <s:property value="#xtxxyz2.tjsj" /></option>
					...
					<td width="15%" class="center">
						...
						期号<s:property value="htkssjs" />费用合计： <s:property value="costsum" />  万元
                            ...
                            <div class="table-responsive">
                               <table class="table  table-hover" >
								 ...
								 <div class="digg">
									...
									        
										<s:else>
										 <a href="dosearchXtxx?htkssjs=<s:property value="htkssjs"/>&&pageNow=1">首页</a>
										 <a href="dosearchXtxx?htkssjs=<s:property value="htkssjs"/>&&pageNow=<s:property value="pageNow-1"/>">上一页</a>
										</s:else>
									...
									<s:else>
									<a href="dosearchXtxx?htkssjs=<s:property value="htkssjs"/>&&pageNow=<s:property value="#i"/>"><s:property value="#i" /></a>
									</s:else>
									...
									        
										<s:else>
										 <a href="dosearchXtxx?htkssjs=<s:property value="htkssjs"/>&&pageNow=<s:property value="pageNow+1"/>">下一页</a>
										 <a href="dosearchXtxx?htkssjs=<s:property value="htkssjs"/>&&pageNow=<s:property value="totalPage"/>">尾页</a>
										</s:else>
								</div>
                            </div>
