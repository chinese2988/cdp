            ...
            <div id="page-inner">
                ...
                <div class="card">
                        ...
                        <div class="card-content">
                           <div class="col">
							  <ul class="tabs">
								<li class="tab col s3"><a class="active" href="#test1">服务查询</a></li>
								<li class="tab col s3"><a  href="#test2">服务申请</a></li>
				...
				<div class="table-responsive">
                        ...
                        <div class="card-content">
							  ...
							  <s:form action="zancun" method="post" name="zancun">
								<table  >
									<tr >
										<td class="center" width="10%">系统名称</td>
										<td class="center" colspan="7"  width="90%">
										<s:if test="xtxxsSize>0">
											<select style="display:block" name="fwsqb.xtbh">
												<s:iterator value="xtxxs" var="xtxx">
											
											  <option value="<s:property value="#xtxx.xtbh"/>"><s:property value="#xtxx.xtmc"/></option>
											  </s:iterator>
											  
											</select>
										</s:if>
										<s:else>
										<div class="input-field"><input id="xtmc_name" name="fwsqb.xtmc" type="text" class="validate">
										<label for="xtmc_name">请填写信息系统名称，并与申请函名称保持一致，系统名称要与系统备案时的名称一致</label></div>
									...
									<tr>
										...
										<select style="display:block" name="fwsqb.bmbh">
												<s:iterator value="depts" var="department">
											 
											  <option value="<s:property value="#department.bmbh"/>"><s:property value="#department.bmmc"/></option>
											  </s:iterator>
										...
										<input  id="dwdz_name" type="text" class="validate" name="fwsqb.apply_address">
										<label for="dwdz_name">请填写单位地址</label>
										</div>
									...
									<tr>
										...
										<td class="center">
										<div class="input-field ">
										<input  id="dwyg_name" type="text" class="validate" name="fwsqb.apply_linkman">
										<label for="dwyg_name">请填姓名(必填)</label>
										</div>
										</td>
										<td class="center">手机</td>
										<td class="center">
										<div class="input-field ">
										<input  id="dwph_name" type="text" class="validate" name="fwsqb.apply_phone">
										<label for="dwph_name">请手机号码(必填)</label>
										</div>
										</td>
										<td class="center">邮箱</td>
										<td class="center">
										<div class="input-field ">
										<input id="email" type="email" class="validate" name="fwsqb.apply_email">
									    <label for="email" data-error="wrong" data-success="right">请邮箱(必填)</label>
										</div>
									    </td>
									...
									<tr>
										...
										<td class="center">
										<div class="input-field " >
										<input  id="dwyg_name2" type="text" class="validate" name="fwsqb.company">
										<label for="dwyg_name2">公司名称(必填)</label>
										</div>
										</td>
										<td class="center">公司联系人</td>
										<td class="center">
										<div class="input-field ">
										<input  id="dwyg_name2" type="text" class="validate" name="fwsqb.company_linkman">
										<label for="dwyg_name2">请填姓名(必填)</label>
										</div>
										</td>
										<td class="center">手机</td>
										<td class="center">
										<div class="input-field">
										<input  id="dwph_name2" type="text" class="validate" name="fwsqb.company_phone">
										<label for="dwph_name2">请手机号码(必填)</label>
										</div>
										</td>
										<td class="center">邮箱</td>
										<td class="center">
										<div class="input-field ">
										<input id="email2" type="email" class="validate" name="fwsqb.company_email">
									    <label for="email2" data-error="wrong" data-success="right">请邮箱(必填)</label>
										</div>
									    </td>
									...
									<tr>
										...
										<td class="center" colspan="7"  width="90%">
										<div class="input-field"><textarea id="textarea" name="fwsqb.access_system_desc" placeholder="请输入文字" rows="" cols="" ></textarea>
						...
						<div class="card-action">
							...
							<table >
								...
								<td></td>
									...
									<td class="center"> 
									<a class="waves-effect waves-light btn" href='javascript:document.zancun.submit();' ><i class="material-icons left">cloud</i>服务送审</a>
