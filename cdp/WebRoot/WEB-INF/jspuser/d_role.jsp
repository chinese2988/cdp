                            ...
                            <div class="table-responsive">
                               <table class="table  table-hover" >
                                    ...
                                    <tbody>
                                        ...
                                        <s:iterator value="dacsl" var="da">
                    	
			                        <tr class="odd gradeX" onmouseover="this.style.background='#e9f0b2'" onmouseout="this.style.background=''">
			                          <td class="center"><s:property value="#da.xuhao" /></td>
			                            <td class="center"><s:property value="#da.rolename" /></td>
			                            <td class="center"><s:property value="#da.rolestyledetail"/></td>
			                            <td class="center"><s:property value="#da.rolecontentdetail"/> </td>
			                           
			                         <td class="center"><a href="toUpRole?id=<s:property value="#da.id" />" title="修改" class="material-icons dp48">settings_backup_restore</a> 
											<a  href="delRole?id=<s:property value="#da.id" />" title="删除" class="material-icons dp48">my_location</a></td>
								 ...
								 <div class="digg">
									...
									        
										<s:else>
										 <a href="drole?pageNow=1">首页</a>
										 <a href="drole?pageNow=<s:property value="pageNow-1"/>">上一页</a>
										</s:else>
									...
									<s:else>
									<a href="drole?pageNow=<s:property value="#i"/>"><s:property value="#i" /></a>
									</s:else>
									...
									        
										<s:else>
										 <a href="drole?pageNow=<s:property value="pageNow+1"/>">下一页</a>
										 <a href="drole?pageNow=<s:property value="totalPage"/>">尾页</a>
										</s:else>
								</div>
                            </div>
