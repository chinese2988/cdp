		  ...
		  <div class="header"> 
            ...
            <div id="page-inner">
                ...
                <div class="row">
					...
					<div>
					<s:form  action="deptSearch" method="post" name="form1">
					...
					<td width="15%" class="center">
						...
						<select style="display:block" name="sbmbh">
						<s:iterator   value="deptss" var="dept"> 
						 	<option value="<s:property value="#dept.bmbh"/>"  ><s:property value="#dept.bmmc"/></option>
						</s:iterator>
						</select>
						
					</td>
					<td width="15%" class="center">  
					<a class="waves-effect waves-light btn" onclick="btn2()"  id="doserch" >查询</a>
					</td>
                            ...
                            <div class="table-responsive">
                               <table class="table  table-hover" >
                                    <thead>
			                            ...
			                            <th class="center">规划容量</th>
			                            <th class="center">使用容量</th>
			                            <th class="center">剩余容量</th>
			                            <th class="center">单位地址</th>
			                            <th class="center">部门简称</th>
			                        ...
			                        <tr class="odd gradeX" onmouseover="this.style.background='#e9f0b2'" onmouseout="this.style.background=''">
			                          <td class="center"><s:property value="#dept.id" /></td>
			                            <td class="center"><s:property value="#dept.bmbh" /></td>
			                            <td class="center"><s:property value="#dept.bmmc"/></td>
			                            <td class="center"><s:property value="#dept.ghrl"/> G</td>
			                           <td class="center"><s:property value="#dept.syrl"/> G</td>
			                           <td class="center"><s:property value="#dept.kxrl"/> G</td>
			                           <td class="center"><s:property value="#dept.dwdz"/></td>
			                         <td class="center"><s:property value="#dept.bmjc"/></td>
								 ...
								 <div class="digg">
									...
									        
										<s:else>
										 <a href="department?pageNow=1">首页</a>
										 <a href="department?pageNow=<s:property value="pageNow-1"/>">上一页</a>
										</s:else>
									...
									<s:else>
									<a href="department?pageNow=<s:property value="#i"/>"><s:property value="#i" /></a>
									</s:else>
									...
									        
										<s:else>
										 <a href="department?pageNow=<s:property value="pageNow+1"/>">下一页</a>
										 <a href="department?pageNow=<s:property value="totalPage"/>">尾页</a>
										</s:else>
								</div>
                            </div>
...
function btn2(){
var inputs=document.getElementsByName("sbmbh");
  for( var i=0;i<inputs.length;i++){
    var input=inputs[i];
    var p='deptSearch?sbmbh='+input.value;
   	document.getElementById("doserch").href =p;
